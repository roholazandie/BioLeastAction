...
# Load the checkpoint
checkpoint_path = "checkpoints/all_cells_vocabulary_cell_type/checkpoint-79000"  # specify the checkpoint path here
...
train_dataset, eval_dataset = get_dataset(dataset_name="reprogramming_schiebinger_fast",
                                          adata=adata,
                                          T=data_temperature,
                                          embedding_size=712,
                                          shuffle=True)
...
if do_animation:
    animate_simulated_trajectories(adata=adata,
                                   ...
                                   # save=f"figures/cell_types/generated_trajectories_repeat_penalty_{repetition_penalty}.mp4",
