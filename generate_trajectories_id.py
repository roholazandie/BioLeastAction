...
with open("generated_trajectories_ids.npy", "wb") as f:
...
adata = ad.read_h5ad("reprogramming_schiebinger_force_directed.h5ad")

generated_trajectories_ids = np.load("generated_trajectories_ids.npy", allow_pickle=True)
...
if do_animation:
    ...
    animate_simulated_trajectories(adata=adata,
         ...
         save=f"figures/generated_trajectories_{top_k}_{top_p}_{temperature}_2.mp4",
