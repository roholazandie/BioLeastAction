...
class VAE(nn.Module):
    ...
    def generate(self, x, sample_shape, random=False):
        ...
        if self.distribution == 'zinb':
            distribution = ZeroInflatedNegativeBinomial(total_count=theta, logits=nb_logits, gate_logits=dropout_logits,
                                                        validate_args=False)
...
def main(data_directory,
    ...
    vae = VAE(input_dim=X.shape[1], hidden_dim=400, latent_dim=40,
